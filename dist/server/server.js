...
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
	"menuItem": `menuitemslist__menuItem--F4Mjc`,
	"menuItemDesktop": `menuitemslist__menuItemDesktop--CUSed`,
	"divider": `menuitemslist__divider--NSfrl`,
	"dividerDesktop": `menuitemslist__dividerDesktop--ZjIjt`
});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
	...
	"dropdown": `menu__dropdown--dbmJv`,
	"closeButton": `menu__closeButton--bSQll`
});
...
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
	"container": `dropdown__container--dt6ns`,
	"listContainer": `dropdown__listContainer--Q6YJw`,
	"list": `dropdown__list--dSmoa`
});


/***/ }),

/***/ "./src/shared/Header/SeachBlock/UserBlock/userblock.css":
/*!**************************************************************!*\
  !*** ./src/shared/Header/SeachBlock/UserBlock/userblock.css ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
	"userBox": `userblock__userBox--NToib`,
	"avatarBox": `userblock__avatarBox--mzv73`,
	"avatarImage": `userblock__avatarImage--kD0aH`,
	"username": `userblock__username--wcTfj`
});


/***/ }),

/***/ "./src/shared/Header/SeachBlock/seachblock.css":
/*!*****************************************************!*\
  !*** ./src/shared/Header/SeachBlock/seachblock.css ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
	"searchBlock": `seachblock__searchBlock--Lpfd7`
});
...
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
	"SortBlock": `sortblock__SortBlock--HADXy`
});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
	...
	"s12": `text__s12--a8D6A`,
	"s10": `text__s10--JLRe9`,
	"black": `text__black--HTnbj`,
	"orange": `text__orange--MlRVH`,
	"green": `text__green--zEinV`,
	"grayF4": `text__grayF4--qIdYj`,
	"grayEC": `text__grayEC--lGHYT`,
	"grayF3": `text__grayF3--D6ed6`,
	"grayD9": `text__grayD9--Mimhd`,
	"grayC4": `text__grayC4--XvIrx`,
	"gray99": `text__gray99--kdHKm`,
	"gray66": `text__gray66--lO6MY`,
	"m28": `text__m28--QsuLD`,
	"m20": `text__m20--zrLCf`,
	"m16": `text__m16--kioX4`,
	"m14": `text__m14--uPREK`,
...
const router_1 = __webpack_require__(/*! @remix-run/router */ "./node_modules/@remix-run/router/dist/router.js");
function _extends() {
    _extends = Object.assign ? Object.assign.bind() : function (target) {
        for (var i = 1; i < arguments.length; i++) {
            var source = arguments[i];
...
function getFormEncType(encType) {
    if (encType != null && !supportedFormEncTypes.has(encType)) {
         true ? (0, router_1.UNSAFE_warning)(false, "\"" + encType + "\" is not a valid `encType` for `<Form>`/`<fetcher.Form>` " + ("and will default to \"" + defaultEncType + "\"")) : 0;
        return null;
    }
    return encType;
}
...
function RouterProvider(_ref) {
    ...
    React.useEffect(() => {
        if (renderDfd && pendingState && router.window) {
            ...
            let transition = router.window.document.startViewTransition(() => __awaiter(this, void 0, void 0, function* () {
                optInStartTransition(() => setStateImpl(newState));
                yield renderPromise;
            }));
    ...
    React.useEffect(() => {
         true ? (0, router_1.UNSAFE_warning)(fallbackElement == null || !router.future.v7_partialHydration, "`<RouterProvider fallbackElement>` is deprecated when using " + "`v7_partialHydration`, use a `HydrateFallback` component instead") : 0;
...
const Link = /*#__PURE__*/ React.forwardRef(function LinkWithRef(_ref7, ref) {
    ...
    let { basename } = React.useContext(react_router_1.UNSAFE_NavigationContext);
    ...
    if (typeof to === "string" && ABSOLUTE_URL_REGEX.test(to)) {
        ...
        if (isBrowser) {
            try {
                ...
                let path = (0, router_1.stripBasename)(targetUrl.pathname, basename);
                ...
                // We can't do external URL detection without a valid URL
                 true ? (0, router_1.UNSAFE_warning)(false, "<Link to=\"" + to + "\"> contains an invalid URL which will probably break " + "when clicked - please update to a valid URL path.") : 0;
            }
        }
    }
    // Rendered into <a href> for relative URLs
    let href = (0, react_router_1.useHref)(to, {
        relative
    });
...
const NavLink = /*#__PURE__*/ React.forwardRef(function NavLinkWithRef(_ref8, ref) {
    ...
    let path = (0, react_router_1.useResolvedPath)(to, {
        relative: rest.relative
    });
    let location = (0, react_router_1.useLocation)();
    let routerState = React.useContext(react_router_1.UNSAFE_DataRouterStateContext);
    let { navigator, basename } = React.useContext(react_router_1.UNSAFE_NavigationContext);
    ...
    if (nextLocationPathname && basename) {
        nextLocationPathname = (0, router_1.stripBasename)(nextLocationPathname, basename) || nextLocationPathname;
    }
...
function useDataRouterContext(hookName) {
    let ctx = React.useContext(react_router_1.UNSAFE_DataRouterContext);
    !ctx ?  true ? (0, router_1.UNSAFE_invariant)(false, getDataRouterConsoleError(hookName)) : 0 : void 0;
    return ctx;
}
function useDataRouterState(hookName) {
    let state = React.useContext(react_router_1.UNSAFE_DataRouterStateContext);
    !state ?  true ? (0, router_1.UNSAFE_invariant)(false, getDataRouterConsoleError(hookName)) : 0 : void 0;
    return state;
}
// External hooks
/**
...
function useLinkClickHandler(to, _temp) {
    ...
    return React.useCallback(event => {
        if (shouldProcessLinkClick(event, target)) {
            ...
            let replace = replaceProp !== undefined ? replaceProp : (0, react_router_1.createPath)(location) === (0, react_router_1.createPath)(path);
            navigate(to, {
                replace,
                state,
                preventScrollReset,
...
function useSubmit() {
    ...
    let { basename } = React.useContext(react_router_1.UNSAFE_NavigationContext);
    let currentRouteId = (0, react_router_1.UNSAFE_useRouteId)();
...
function useFormAction(action, _temp2) {
    ...
    let { basename } = React.useContext(react_router_1.UNSAFE_NavigationContext);
    let routeContext = React.useContext(react_router_1.UNSAFE_RouteContext);
    !routeContext ?  true ? (0, router_1.UNSAFE_invariant)(false, "useFormAction must be used inside a RouteContext") : 0 : void 0;
    let [match] = routeContext.matches.slice(-1);
    // Shallow clone path so we can modify it below, otherwise we modify the
    // object referenced by useMemo inside useResolvedPath
    let path = _extends({}, (0, react_router_1.useResolvedPath)(action ? action : ".", {
        relative
    }));
...
function useFetcher(_temp3) {
    ...
    let route = React.useContext(react_router_1.UNSAFE_RouteContext);
    let routeId = (_route$matches = route.matches[route.matches.length - 1]) == null ? void 0 : _route$matches.route.id;
    !fetcherData ?  true ? (0, router_1.UNSAFE_invariant)(false, "useFetcher must be used inside a FetchersContext") : 0 : void 0;
    !route ?  true ? (0, router_1.UNSAFE_invariant)(false, "useFetcher must be used inside a RouteContext") : 0 : void 0;
    !(routeId != null) ?  true ? (0, router_1.UNSAFE_invariant)(false, "useFetcher can only be used on routes that contain a unique \"id\"") : 0 : void 0;
    ...
    let load = React.useCallback((href, opts) => {
        !routeId ?  true ? (0, router_1.UNSAFE_invariant)(false, "No routeId available for fetcher.load()") : 0 : void 0;
    ...
    let fetcher = state.fetchers.get(fetcherKey) || router_1.IDLE_FETCHER;
...
function useScrollRestoration(_temp4) {
    ...
    let { basename } = React.useContext(react_router_1.UNSAFE_NavigationContext);
    let location = (0, react_router_1.useLocation)();
    let matches = (0, react_router_1.useMatches)();
    let navigation = (0, react_router_1.useNavigation)();
    ...
    usePageHide(React.useCallback(() => {
        ...
        try {
            sessionStorage.setItem(storageKey || SCROLL_RESTORATION_STORAGE_KEY, JSON.stringify(savedScrollPositions));
             ...
             true ? (0, router_1.UNSAFE_warning)(false, "Failed to save scroll positions in sessionStorage, <ScrollRestoration /> will not work properly (" + error + ").") : 0;
        }
        window.history.scrollRestoration = "auto";
...
function usePrompt(_ref12) {
    ...
    let blocker = (0, react_router_1.useBlocker)(when);
    React.useEffect(() => {
...
function useViewTransitionState(to, opts) {
    ...
    !(vtContext != null) ?  true ? (0, router_1.UNSAFE_invariant)(false, "`unstable_useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  " + "Did you accidentally import `RouterProvider` from `react-router`?") : 0 : void 0;
    ...
    let currentPath = (0, router_1.stripBasename)(vtContext.currentLocation.pathname, basename) || vtContext.currentLocation.pathname;
    let nextPath = (0, router_1.stripBasename)(vtContext.nextLocation.pathname, basename) || vtContext.nextLocation.pathname;
...
function useMatch(pattern) {
    ...
    return React.useMemo(() => (0, router_1.matchPath)(pattern, pathname), [pathname, pattern]);
}
...
function useNavigateUnstable() {
    ...
    let routePathnamesJson = JSON.stringify((0, router_1.UNSAFE_getResolveToMatches)(matches, future.v7_relativeSplatPath));
    ...
    let navigate = React.useCallback(function (to, options) {
        if (options === void 0) {
         ...
         true ? (0, router_1.UNSAFE_warning)(activeRef.current, navigateEffectWarning) : 0;
        ...
        let path = (0, router_1.resolveTo)(to, JSON.parse(routePathnamesJson), locationPathname, options.relative === "path");
        // If we're operating within a basename, prepend it to the pathname prior
...
function useResolvedPath(to, _temp2) {
    ...
    let { pathname: locationPathname } = useLocation();
    let routePathnamesJson = JSON.stringify((0, router_1.UNSAFE_getResolveToMatches)(matches, future.v7_relativeSplatPath));
    return React.useMemo(() => (0, router_1.resolveTo)(to, JSON.parse(routePathnamesJson), locationPathname, relative === "path"), [to, routePathnamesJson, locationPathname, relative]);
}
...
function useRoutesImpl(routes, locationArg, dataRouterState, future) {
    ...
    if (locationArg) {
        ...
        let parsedLocationArg = typeof locationArg === "string" ? (0, router_1.parsePath)(locationArg) : locationArg;
    ...
    let matches = (0, router_1.matchRoutes)(routes, {
        pathname: remainingPathname
    });
    if (true) {
         true ? (0, router_1.UNSAFE_warning)(parentRoute || matches != null, "No routes matched location \"" + location.pathname + location.search + location.hash + "\" ") : 0;
...
function DefaultErrorComponent() {
    ...
    let message = (0, router_1.isRouteErrorResponse)(error) ? error.status + " " + error.statusText : error instanceof Error ? error.message : JSON.stringify(error);
...
function _renderMatches(matches, parentMatches, dataRouterState, future) {
    ...
    if (errors != null) {
        ...
        !(errorIndex >= 0) ?  true ? (0, router_1.UNSAFE_invariant)(false, "Could not find a matching route for errors on route IDs: " + Object.keys(errors).join(",")) : 0 : void 0;
...
function useRouteContext(hookName) {
    ...
    !route ?  true ? (0, router_1.UNSAFE_invariant)(false, getDataRouterConsoleError(hookName)) : 0 : void 0;
    return route;
}
...
function useCurrentRouteId(hookName) {
    ...
    !thisRoute.route.id ?  true ? (0, router_1.UNSAFE_invariant)(false, hookName + " can only be used on routes that contain a unique \"id\"") : 0 : void 0;
...
function useMatches() {
    ...
    return React.useMemo(() => matches.map(m => (0, router_1.UNSAFE_convertRouteMatchToUiMatch)(m, loaderData)), [matches, loaderData]);
}
...
function warningOnce(key, cond, message) {
    if (!cond && !alreadyWarned[key]) {
        alreadyWarned[key] = true;
         true ? (0, router_1.UNSAFE_warning)(false, message) : 0;
    }
}
/**
  Webpack + React 17 fails to compile on any of the following because webpack
...
function Navigate(_ref4) {
    ...
    let { future, static: isStatic } = React.useContext(NavigationContext);
     true ? (0, router_1.UNSAFE_warning)(!isStatic, "<Navigate> must not be used on the initial render in a <StaticRouter>. " + "This is a no-op, but you should modify your code so the <Navigate> is " + "only ever rendered in response to some user interaction or state change.") : 0;
    let { matches } = React.useContext(RouteContext);
    let { pathname: locationPathname } = useLocation();
    let navigate = useNavigate();
    // Resolve the path outside of the effect so that when effects run twice in
    // StrictMode they navigate to the same place
    let path = (0, router_1.resolveTo)(to, (0, router_1.UNSAFE_getResolveToMatches)(matches, future.v7_relativeSplatPath), locationPathname, relative === "path");
...
function Route(_props) {
     true ? (0, router_1.UNSAFE_invariant)(false, "A <Route> is only ever to be used as the child of <Routes> element, " + "never rendered directly. Please wrap your <Route> in a <Routes>.") : 0;
}
exports.Route = Route;
/**
...
function Router(_ref5) {
    let { basename: basenameProp = "/", children = null, location: locationProp, navigationType = router_1.Action.Pop, navigator, static: staticProp = false, future } = _ref5;
    !!useInRouterContext() ?  true ? (0, router_1.UNSAFE_invariant)(false, "You cannot render a <Router> inside another <Router>." + " You should never have more than one in your app.") : 0 : void 0;
    ...
    let locationContext = React.useMemo(() => {
        let trailingPathname = (0, router_1.stripBasename)(pathname, basename);
     ...
     true ? (0, router_1.UNSAFE_warning)(locationContext != null, "<Router basename=\"" + basename + "\"> is not able to match the URL " + ("\"" + pathname + search + hash + "\" because it does not start with the ") + "basename, so the <Router> won't render anything.") : 0;
...
function createRoutesFromChildren(children, parentPath) {
    ...
    React.Children.forEach(children, (element, index) => {
        ...
        !(element.type === Route) ?  true ? (0, router_1.UNSAFE_invariant)(false, "[" + (typeof element.type === "string" ? element.type : element.type.name) + "] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>") : 0 : void 0;
        !(!element.props.index || !element.props.children) ?  true ? (0, router_1.UNSAFE_invariant)(false, "An index route cannot have child routes.") : 0 : void 0;
        let route = {
...
function mapRouteProperties(route) {
    ...
    if (route.Component) {
        if (true) {
            if (route.element) {
                 true ? (0, router_1.UNSAFE_warning)(false, "You should not include both `Component` and `element` on your route - " + "`Component` will be used.") : 0;
            }
        }
    ...
    if (route.HydrateFallback) {
        if (true) {
            if (route.hydrateFallbackElement) {
                 true ? (0, router_1.UNSAFE_warning)(false, "You should not include both `HydrateFallback` and `hydrateFallbackElement` on your route - " + "`HydrateFallback` will be used.") : 0;
            }
        }
        Object.assign(updates, {
    ...
    if (route.ErrorBoundary) {
        if (true) {
            if (route.errorElement) {
                 true ? (0, router_1.UNSAFE_warning)(false, "You should not include both `ErrorBoundary` and `errorElement` on your route - " + "`ErrorBoundary` will be used.") : 0;
            }
        }
        Object.assign(updates, {
...
const GenericList_1 = __webpack_require__(/*! ./shared/GenericList */ "./src/shared/GenericList/index.ts");
...
const Post_1 = __webpack_require__(/*! ./shared/CardsList/Post */ "./src/shared/CardsList/Post/index.ts");
...
const LIST = [
    ...
    { text: 'Ещё что то там' },
    { text: 'Там что то ещё' },
].map(genereteRandomIndex_1.generateID);
...
app.get('/auth', (req, res) => {
    axios_1.default.post('https://www.reddit.com/api/v1/access_token', `grant_type=authorization_code&code=${req.query.code}&redirect_uri=http://localhost:3000/auth`, {
        auth: { username: 'CsIig-AA7L5j8R4E3K2cUg', password: 'FZSALvaFy_A3iz43ZpQ_wTbhl4zroQ' },
...
function Card({ title, author, url, is_video }) {
    return (react_1.default.createElement("li", { className: card_css_1.default.card },
        react_1.default.createElement(TextContent_1.TextContent, { title: title, author: author }),
        react_1.default.createElement(Preview_1.Preview, { url: url, is_video: is_video }),
    ...
    return (react_1.default.createElement("div", { className: controls_css_1.default.controls },
        react_1.default.createElement("div", { className: controls_css_1.default.karmaCounter },
            react_1.default.createElement("button", { className: controls_css_1.default.up },
                react_1.default.createElement("svg", { width: '19', height: '10', viewBox: '0 0 19 10', fill: "none" },
                    react_1.default.createElement("path", { d: "M9.5 0L0 10H19L9.5 0Z", fill: "#C4C4C4" }))),
            react_1.default.createElement("span", { className: controls_css_1.default.karmaValue }, "123"),
        ...
        react_1.default.createElement("button", { className: controls_css_1.default.commentsButton },
            react_1.default.createElement("svg", { fill: "#c4c4c4", width: "15px", height: "15px", viewBox: "-0.5 0.5 42 42", stroke: "#c4c4c4" },
                react_1.default.createElement("path", { d: "M29.5,30.5h7c2.529,0,3-0.529,3-3v-21c0-2.41-0.59-3-3-3h-32c-2.47,0-3,0.53-3,3v20.971c0,2.469,0.41,3.029,3,3.029h13 c0,0,9.562,8.756,10.75,9.812c0.422,0.375,1.281,0.172,1.25-0.812V30.5z M7.5,21.5h21v3h-21V21.5z M7.5,15.5h13v3h-13V15.5z M7.5,9.5h26v3h-26V9.5z" })),
        ...
        react_1.default.createElement("div", { className: controls_css_1.default.actions },
            ...
            react_1.default.createElement("svg", { viewBox: "-2.4 -2.4 28.80 28.80", fill: "none", width: 20, height: 20 },
                react_1.default.createElement("rect", { x: "-2.4", y: "-2.4", width: "28.80", height: "28.80", rx: "14.4", fill: "#c4c4c4" }),
                react_1.default.createElement("path", { d: "M13.803 5.33333C13.803 3.49238 15.3022 2 17.1515 2C19.0008 2 20.5 3.49238 20.5 5.33333C20.5 7.17428 19.0008 8.66667 17.1515 8.66667C16.2177 8.66667 15.3738 8.28596 14.7671 7.67347L10.1317 10.8295C10.1745 11.0425 10.197 11.2625 10.197 11.4872C10.197 11.9322 10.109 12.3576 9.94959 12.7464L15.0323 16.0858C15.6092 15.6161 16.3473 15.3333 17.1515 15.3333C19.0008 15.3333 20.5 16.8257 20.5 18.6667C20.5 20.5076 19.0008 22 17.1515 22C15.3022 22 13.803 20.5076 13.803 18.6667C13.803 18.1845 13.9062 17.7255 14.0917 17.3111L9.05007 13.9987C8.46196 14.5098 7.6916 14.8205 6.84848 14.8205C4.99917 14.8205 3.5 13.3281 3.5 11.4872C3.5 9.64623 4.99917 8.15385 6.84848 8.15385C7.9119 8.15385 8.85853 8.64725 9.47145 9.41518L13.9639 6.35642C13.8594 6.03359 13.803 5.6896 13.803 5.33333Z", fill: "#ffffff" })),
            react_1.default.createElement("button", { className: controls_css_1.default.saveButton },
                react_1.default.createElement("svg", { width: "20px", height: "20px", viewBox: "-5.28 -5.28 34.56 34.56", fill: "none" },
                    react_1.default.createElement("rect", { x: "-5.28", y: "-5.28", width: "34.56", height: "34.56", rx: "17.28", fill: "#c4c4c4" }),
                    react_1.default.createElement("path", { d: "M21.9998 5.11V16.47C21.9998 17.92 20.9598 18.53 19.6898 17.83L17.7598 16.75C17.5998 16.66 17.4998 16.49 17.4998 16.31V8.99C17.4998 6.45 15.4298 4.38 12.8898 4.38H8.81984C8.44984 4.38 8.18984 3.99 8.35984 3.67C8.87984 2.68 9.91984 2 11.1098 2H18.8898C20.5998 2 21.9998 3.4 21.9998 5.11Z", fill: "#ffffff" }),
                    " ",
                    react_1.default.createElement("path", { d: "M12.89 5.87891H5.11C3.4 5.87891 2 7.27891 2 8.98891V20.3489C2 21.7989 3.04 22.4089 4.31 21.7089L8.24 19.5189C8.66 19.2889 9.34 19.2889 9.76 19.5189L13.69 21.7089C14.96 22.4089 16 21.7989 16 20.3489V8.98891C16 7.27891 14.6 5.87891 12.89 5.87891ZM11 12.7489H9.75V13.9989C9.75 14.4089 9.41 14.7489 9 14.7489C8.59 14.7489 8.25 14.4089 8.25 13.9989V12.7489H7C6.59 12.7489 6.25 12.4089 6.25 11.9989C6.25 11.5889 6.59 11.2489 7 11.2489H8.25V9.99891C8.25 9.58891 8.59 9.24891 9 9.24891C9.41 9.24891 9.75 9.58891 9.75 9.99891V11.2489H11C11.41 11.2489 11.75 11.5889 11.75 11.9989C11.75 12.4089 11.41 12.7489 11 12.7489Z", fill: "#ffffff" }))))));
}
...
const MenuItemsList_1 = __webpack_require__(/*! ./MenuItemsList */ "./src/shared/CardsList/Card/Menu/MenuItemsList/index.ts");
function Menu() {
    return (react_1.default.createElement("div", { className: menu_css_1.default.menu },
        react_1.default.createElement(Dropdown_1.Dropdown, { button: react_1.default.createElement("button", { className: menu_css_1.default.menuButton },
            ...
            react_1.default.createElement("div", { className: menu_css_1.default.dropdown },
                react_1.default.createElement(MenuItemsList_1.MenuItemsList, { postId: '31231' }),
                react_1.default.createElement("button", { className: menu_css_1.default.closeButton }, "\u0417\u0430\u043A\u0440\u044B\u0442\u044C")))));
}
exports.Menu = Menu;
...
const react_1 = __importDefault(__webpack_require__(/*! react */ "react"));
const menuitemslist_css_1 = __importDefault(__webpack_require__(/*! ./menuitemslist.css */ "./src/shared/CardsList/Card/Menu/MenuItemsList/menuitemslist.css"));
const Icons_1 = __webpack_require__(/*! ../../../../Icons */ "./src/shared/Icons/index.ts");
function MenuItemsList({ postId }) {
    return (react_1.default.createElement("ul", { className: menuitemslist_css_1.default.menuItemsList },
        react_1.default.createElement("li", { className: `${menuitemslist_css_1.default.menuItemDesktop} ${menuitemslist_css_1.default.menuItem}`, onClick: () => console.log(postId) },
            react_1.default.createElement(Icons_1.CommentIcon, null),
            "\u041A\u043E\u043C\u043C\u0435\u043D\u0442\u0430\u0440\u0438\u0438"),
        react_1.default.createElement("div", { className: `${menuitemslist_css_1.default.divider} ${menuitemslist_css_1.default.dividerDesktop}` }),
        react_1.default.createElement("li", { className: `${menuitemslist_css_1.default.menuItemDesktop} ${menuitemslist_css_1.default.menuItem}`, onClick: () => console.log(postId) },
            react_1.default.createElement(Icons_1.ShareIcon, null),
            "\u041F\u043E\u0434\u0435\u043B\u0438\u0442\u044C\u0441\u044F"),
        react_1.default.createElement("div", { className: `${menuitemslist_css_1.default.divider} ${menuitemslist_css_1.default.dividerDesktop}` }),
        react_1.default.createElement("li", { className: menuitemslist_css_1.default.menuItem, onClick: () => console.log(postId) },
...
function Preview({ url, is_video }) {
    return (react_1.default.createElement("div", { className: preview_css_1.default.preview }, !is_video ?
        (react_1.default.createElement("img", { className: preview_css_1.default.previewImg, src: url })) : (react_1.default.createElement("img", { className: preview_css_1.default.previewImg, src: 'https://g.foolcdn.com/image/?url=https%3A//g.foolcdn.com/editorial/images/579162/gettyimages-1145887344.jpg&w=2000&op=resize' }))));
}
...
function TextContent({ title, author }) {
    return (react_1.default.createElement("div", { className: textcontent_css_1.default.textContent },
        ...
        react_1.default.createElement("h2", { className: textcontent_css_1.default.title },
            react_1.default.createElement(react_router_dom_1.Link, { to: "/posts/123", className: textcontent_css_1.default.postLink }, title))));
}
...
function CardsList() {
    ...
    (0, react_1.useEffect)(() => {
        ...
        function load() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                setErrorLoading('');
                try {
                    const response = yield axios_1.default.get('https://oauth.reddit.com/new/', {
    ...
    return (react_1.default.createElement("ul", { className: cardslist_css_1.default.cardsList },
        posts.map((post) => (react_1.default.createElement(Card_1.Card, { key: post.data.id, title: post.data.title, author: post.data.author, url: post.data.url, is_video: post.data.is_video }))),
...
function Post(props) {
    ...
    return react_dom_1.default.createPortal((react_1.default.createElement("div", { className: post_css_1.default.modal },
        react_1.default.createElement("div", { className: post_css_1.default.content, ref: ref },
            ...
            react_1.default.createElement("button", { className: post_css_1.default.btnClose, onClick: () => navigate("/") }, "+"),
...
/***/ "./src/shared/Header/SeachBlock/SeachBlock.tsx":
/*!*****************************************************!*\
  !*** ./src/shared/Header/SeachBlock/SeachBlock.tsx ***!
  \*****************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./src/shared/Header/SeachBlock/UserBlock/UserBlock.tsx":
/*!**************************************************************!*\
  !*** ./src/shared/Header/SeachBlock/UserBlock/UserBlock.tsx ***!
  \**************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./src/shared/Header/SeachBlock/UserBlock/index.ts":
/*!*********************************************************!*\
  !*** ./src/shared/Header/SeachBlock/UserBlock/index.ts ***!
  \*********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./UserBlock */ "./src/shared/Header/SeachBlock/UserBlock/UserBlock.tsx"), exports);


/***/ }),

/***/ "./src/shared/Header/SeachBlock/index.ts":
/*!***********************************************!*\
  !*** ./src/shared/Header/SeachBlock/index.ts ***!
  \***********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./SeachBlock */ "./src/shared/Header/SeachBlock/SeachBlock.tsx"), exports);
...
const react_1 = __importDefault(__webpack_require__(/*! react */ "react"));
function BlockIcon() {
    return (react_1.default.createElement("svg", { width: "14px", height: "14px", viewBox: "-2.4 -2.4 28.80 28.80", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        react_1.default.createElement("g", { id: "SVGRepo_bgCarrier" },
            react_1.default.createElement("rect", { x: "-2.4", y: "-2.4", width: "28.80", height: "28.80", rx: "14.4", fill: "#c4c4c4" })),
        react_1.default.createElement("g", { id: "SVGRepo_tracerCarrier" }),
        react_1.default.createElement("g", { id: "SVGRepo_iconCarrier" },
            " ",
            react_1.default.createElement("g", { id: "Edit / Hide" },
                " ",
                react_1.default.createElement("path", { id: "Vector", d: "M3.99989 4L19.9999 20M16.4999 16.7559C15.1473 17.4845 13.6185 17.9999 11.9999 17.9999C8.46924 17.9999 5.36624 15.5478 3.5868 13.7788C3.1171 13.3119 2.88229 13.0784 2.7328 12.6201C2.62619 12.2933 2.62616 11.7066 2.7328 11.3797C2.88233 10.9215 3.11763 10.6875 3.58827 10.2197C4.48515 9.32821 5.71801 8.26359 7.17219 7.42676M19.4999 14.6335C19.8329 14.3405 20.138 14.0523 20.4117 13.7803L20.4146 13.7772C20.8832 13.3114 21.1182 13.0779 21.2674 12.6206C21.374 12.2938 21.3738 11.7068 21.2672 11.38C21.1178 10.9219 20.8827 10.6877 20.4133 10.2211C18.6338 8.45208 15.5305 6 11.9999 6C11.6624 6 11.3288 6.02241 10.9999 6.06448M13.3228 13.5C12.9702 13.8112 12.5071 14 11.9999 14C10.8953 14 9.99989 13.1046 9.99989 12C9.99989 11.4605 10.2135 10.9711 10.5608 10.6113", stroke: "#ffffff" }),
                " "),
            " ")));
}
...
function CommentIcon() {
    return (react_1.default.createElement("svg", { height: "14px", width: "14px", version: "1.1", id: "_x32_", viewBox: "0 0 512 512", fill: "#C4C4C4" },
        react_1.default.createElement("g", { id: "SVGRepo_iconCarrier" },
            " ",
...
const react_1 = __importDefault(__webpack_require__(/*! react */ "react"));
function IconAnon() {
    return (react_1.default.createElement("svg", { width: "50px", height: "50px", viewBox: "-2.4 -2.4 28.80 28.80", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        react_1.default.createElement("g", { id: "SVGRepo_bgCarrier" },
            react_1.default.createElement("rect", { x: "-2.4", y: "-2.4", width: "28.80", height: "28.80", rx: "14.4", fill: "#d9d9d9" })),
        react_1.default.createElement("g", { id: "SVGRepo_tracerCarrier" }),
        react_1.default.createElement("g", { id: "SVGRepo_iconCarrier" },
            " ",
            react_1.default.createElement("path", { d: "M16 7C16 9.20914 14.2091 11 12 11C9.79086 11 8 9.20914 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7Z", stroke: "#ffffff" }),
            " ",
            react_1.default.createElement("path", { d: "M12 14C8.13401 14 5 17.134 5 21H19C19 17.134 15.866 14 12 14Z", stroke: "#ffffff" }),
            " ")));
}
...
const react_1 = __importDefault(__webpack_require__(/*! react */ "react"));
function MenuIcon() {
    return (react_1.default.createElement("svg", { viewBox: "0 0 24 24", fill: "none" },
        react_1.default.createElement("path", { d: "M7 12C7 13.1046 6.10457 14 5 14C3.89543 14 3 13.1046 3 12C3 10.8954 3.89543 10 5 10C6.10457 10 7 10.8954 7 12Z", fill: "#c4c4c4" }),
        react_1.default.createElement("path", { d: "M14 12C14 13.1046 13.1046 14 12 14C10.8954 14 10 13.1046 10 12C10 10.8954 10.8954 10 12 10C13.1046 10 14 10.8954 14 12Z", fill: "#c4c4c4" }),
        react_1.default.createElement("path", { d: "M21 12C21 13.1046 20.1046 14 19 14C17.8954 14 17 13.1046 17 12C17 10.8954 17.8954 10 19 10C20.1046 10 21 10.8954 21 12Z", fill: "#c4c4c4" })));
}
...
const react_1 = __importDefault(__webpack_require__(/*! react */ "react"));
function SaveIcon() {
    return (react_1.default.createElement("svg", { width: "14px", height: "14px", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        react_1.default.createElement("g", { id: "SVGRepo_iconCarrier" },
            " ",
            react_1.default.createElement("path", { d: "M21.9998 5.11V16.47C21.9998 17.92 20.9598 18.53 19.6898 17.83L17.7598 16.75C17.5998 16.66 17.4998 16.49 17.4998 16.31V8.99C17.4998 6.45 15.4298 4.38 12.8898 4.38H8.81984C8.44984 4.38 8.18984 3.99 8.35984 3.67C8.87984 2.68 9.91984 2 11.1098 2H18.8898C20.5998 2 21.9998 3.4 21.9998 5.11Z", fill: "#c4c4c4" }),
            " ",
            react_1.default.createElement("path", { d: "M12.89 5.87891H5.11C3.4 5.87891 2 7.27891 2 8.98891V20.3489C2 21.7989 3.04 22.4089 4.31 21.7089L8.24 19.5189C8.66 19.2889 9.34 19.2889 9.76 19.5189L13.69 21.7089C14.96 22.4089 16 21.7989 16 20.3489V8.98891C16 7.27891 14.6 5.87891 12.89 5.87891ZM11 12.7489H9.75V13.9989C9.75 14.4089 9.41 14.7489 9 14.7489C8.59 14.7489 8.25 14.4089 8.25 13.9989V12.7489H7C6.59 12.7489 6.25 12.4089 6.25 11.9989C6.25 11.5889 6.59 11.2489 7 11.2489H8.25V9.99891C8.25 9.58891 8.59 9.24891 9 9.24891C9.41 9.24891 9.75 9.58891 9.75 9.99891V11.2489H11C11.41 11.2489 11.75 11.5889 11.75 11.9989C11.75 12.4089 11.41 12.7489 11 12.7489Z", fill: "#c4c4c4" }),
            " ")));
}
...
/***/ "./src/shared/Icons/WarninhIcon.tsx":
/*!******************************************!*\
  !*** ./src/shared/Icons/WarninhIcon.tsx ***!
  \******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
function WarningIcon() {
    return (react_1.default.createElement("svg", { width: "14px", height: "14px", viewBox: "0 0 512 512", version: "1.1", xmlns: "http://www.w3.org/2000/svg", fill: "#000000" },
        react_1.default.createElement("g", { id: "SVGRepo_bgCarrier" }),
        react_1.default.createElement("g", { id: "SVGRepo_tracerCarrier" }),
        react_1.default.createElement("g", { id: "SVGRepo_iconCarrier" },
            " ",
            react_1.default.createElement("title", null, "warning-filled"),
            " ",
            react_1.default.createElement("g", { id: "Page-1", stroke: "none", fill: "none" },
                " ",
                react_1.default.createElement("g", { id: "add", fill: "#c4c4c4", transform: "translate(32.000000, 42.666667)" },
                    " ",
                    react_1.default.createElement("path", { d: "M246.312928,5.62892705 C252.927596,9.40873724 258.409564,14.8907053 262.189374,21.5053731 L444.667042,340.84129 C456.358134,361.300701 449.250007,387.363834 428.790595,399.054926 C422.34376,402.738832 415.04715,404.676552 407.622001,404.676552 L42.6666667,404.676552 C19.1025173,404.676552 7.10542736e-15,385.574034 7.10542736e-15,362.009885 C7.10542736e-15,354.584736 1.93772021,347.288125 5.62162594,340.84129 L188.099293,21.5053731 C199.790385,1.04596203 225.853517,-6.06216498 246.312928,5.62892705 Z M224,272 C208.761905,272 197.333333,283.264 197.333333,298.282667 C197.333333,313.984 208.415584,325.248 224,325.248 C239.238095,325.248 250.666667,313.984 250.666667,298.624 C250.666667,283.264 239.238095,272 224,272 Z M245.333333,106.666667 L202.666667,106.666667 L202.666667,234.666667 L245.333333,234.666667 L245.333333,106.666667 Z", id: "Combined-Shape" }, " "),
                    " "),
                " "),
            " ")));
}
...
__exportStar(__webpack_require__(/*! ./WarninhIcon */ "./src/shared/Icons/WarninhIcon.tsx"), exports);
...
/* export function assoc(key: string, value: string) {
    return (obj: object) => ({
        ...obj,
        [key]: value,
    })
...
/***/ "./src/utils/react/genereteRandomIndex.ts":
/*!************************************************!*\
  !*** ./src/utils/react/genereteRandomIndex.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.generateID = exports.assingId = exports.generateRandomString = void 0;
const assoc_1 = __webpack_require__(/*! ../js/assoc */ "./src/utils/js/assoc.ts");
const generateRandomString = () => Math.random().toString(36).substring(2, 15);
exports.generateRandomString = generateRandomString;
exports.assingId = (0, assoc_1.assoc)('id', (0, exports.generateRandomString)());
